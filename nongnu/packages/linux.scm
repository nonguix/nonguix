...
(define-public linux-5.13
  (corrupt-linux linux-libre-5.13 "5.13.3"
                 "1ir80wn019kslv6ysiqxdvarrjlr8b3skk1s43cwki3x2cjnxskq"))

(define-public linux-5.12
  (corrupt-linux linux-libre-5.12 "5.12.18"
                 "12sjscf53z6fc1jah3i2578r3a0i7rkw2jmqi0w328a22i0paakg"))

(define-public linux-5.10
  (corrupt-linux linux-libre-5.10 "5.10.50"
                 "0dmlpy9k7am99495bxcm46i4y6g34d1fzdkzz3wgzb4mgmx35nlb"))

(define-public linux-5.4
  (corrupt-linux linux-libre-5.4 "5.4.132"
                 "1vq0dmrn7gl2vprm08l8by5ja3xjgggrcd38vqg7b7jpnfzssrl4"))

(define-public linux-4.19
  (corrupt-linux linux-libre-4.19 "4.19.197"
                 "10kj442qaky6rpl65k5rrvd3p6mdgz4p321zvf4s312ixfdja0g6"))

(define-public linux-4.14
  (corrupt-linux linux-libre-4.14 "4.14.239"
                 "167zwm3giizv42m0xjz71xnb2swlwiaw0xw0dg8j8mb74hz1drx0"))

(define-public linux-4.9
  (corrupt-linux linux-libre-4.9 "4.9.275"
                 "08mz7mzmhk5n1gwadrc5fw8s40jk0rayvdpjcricl4sv56574lb6"))
