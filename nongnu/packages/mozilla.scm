...
(define %firefox-build-id "20201109000000")
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "14c60mcqcfj4q8xmdn197w997w15sjy8bdbdh720f4dpykn0mx2d"))))
    ...
    (arguments
     `(#:configure-flags
       ...
       (modify-phases %standard-phases
         (add-after 'unpack 'delete-bundled-configuration-and-binaries
           (lambda _
