...
(define nvidia-source-580-x86_64-linux
  (make-nvidia-source
   "580.178.04"
   "x86_64"
   (base32 "1yfnnsj3zwbj3rjssizala38244v2v8k7bjidxicpzsvwipahxar")))

(define nvidia-source-580-aarch64-linux
  (make-nvidia-source
   "580.178.04"
   "aarch64"
   (base32 "0jghqk85xvsmparkxip99jl57nw4rzvw23jmyzb143l54ifyqngg")))

(define nvidia-source-595-x86_64-linux
  (make-nvidia-source
   "595.91.07"
   "x86_64"
   (base32 "04v3bq4qn0c0z50ayjap60vpbpdwnz7i27jfcj8s21sbsa6wh8ya")))

(define nvidia-source-595-aarch64-linux
  (make-nvidia-source
   "595.91.07"
   "aarch64"
   (base32 "016g22k888fgrzdsvii9c7mkgfdfd069kdibbzgd8pj5wgn0vaby")))

(define nvidia-source-new-feature-x86_64-linux
  (make-nvidia-source
   "610.57.04"
   "x86_64"
   (base32 "0v8ixgkpr6n2xv0rq35lhs9dwlpxw078xg2pr3001fw3dg33bsdj")))

(define nvidia-source-new-feature-aarch64-linux
  (make-nvidia-source
   "610.57.04"
   "aarch64"
   (base32 "17lg7x6a2lvj3ckzi54qc03j4g8s75cvz5zcp2q976j2q2n9y9s0")))
...
(define-public nvidia-modprobe-580
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "08h8r5w0z9y854yp8k0c75rnigjh78wi8xk4jfibj3hhq08m6dyv"))))
...
(define-public nvidia-modprobe-595
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "13zcvj5l5d04kaz4spp4jqa910500i6ffxy7gv14pfnh935gvcnc"))))
    (synopsis "Create NVIDIA character device files, production branch")))
...
(define-public nvidia-modprobe-new-feature
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0hvb1n5741zhxf4j3yplcna0krpnhmcvwshskp4z37yhb5ba17il"))))
