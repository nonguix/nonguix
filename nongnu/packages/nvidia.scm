...
(define nvidia-source-580-x86_64-linux
  (make-nvidia-source
   "580.173.02"
   "x86_64"
   (base32 "06vfyhh6hy2jv7gwr1g19s2g4kmnzq2d7mfkcfkaia853q0bk3ld")))

(define nvidia-source-580-aarch64-linux
  (make-nvidia-source
   "580.173.02"
   "aarch64"
   (base32 "105ajyx2wq57a38raznkbwf9199m7j4ag3c09bq7hkgghxhdanyn")))

(define nvidia-source-595-x86_64-linux
  (make-nvidia-source
   "595.84"
   "x86_64"
   (base32 "01msbrn1mkwmm5ql05xbfdxdrgiyrvf6h0nslsy2ggri47jh9i4r")))

(define nvidia-source-595-aarch64-linux
  (make-nvidia-source
   "595.84"
   "aarch64"
   (base32 "06a3mg292jmb551dxn5hxcnfmb6sck9r8h41pdap36az65s0snhs")))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32
         "14bsslkmgx7pa0ybd8dsa3snyhqky581fh9n2n0bcpgssxjnh6cn"))
       (patches
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32
         "1mkhh7f8sqgjnghv7zvqxdv4z3sb5x23gfmc7haaqf0wspd80jd4"))
       (patches
        (nongnu-patches "nvidia-module-open-add-ibt-support.patch"
                        "nvidia-module-open-bsb-dsc-fix.patch"))))
    (synopsis "Proprietary NVIDIA driver (open source kernel modules), production branch")))
...
(define-public nvidia-modprobe-580
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0bwyshiv7ca6ksi768fj4qipi9a8c2dfxchsdncjri852ks8fgvb"))))
...
(define-public nvidia-modprobe-595
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1vzq4rgwfk5lp59glb185insj6lx366bxbax9gz5an2c33646ak9"))))
    (synopsis "Create NVIDIA character device files, production branch")))
    ...
    (source
     (origin
       ...
       (uri (git-reference
              ...
              (commit version)))
       (file-name (git-file-name name version))
       (sha256 (base32 "1hcbnbprw3ij63g6hlb6b8rabiiq9l0pka5m7wgpbh37ggznxxvm"))
       (modules '((guix build utils)))
       (snippet '(delete-file-recursively "src/jansson"))))
    ...
    (source
     (origin
       ...
       (uri (git-reference
              ...
              (commit version)))
       (file-name (git-file-name name version))
       (sha256 (base32 "100bp1x8ij571x8mx9hqi66nnr0yd6ydmfkkd83fwn0xxcrw3fa2"))
       (modules '((guix build utils)))
       (snippet '(delete-file-recursively "src/jansson"))))
    (synopsis "NVIDIA proprietary driver control panel, production branch")))
