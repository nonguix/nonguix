...
(define nvidia-source-580-x86_64-linux
  (make-nvidia-source
   "580.159.03"
   "x86_64"
   (base32 "0xzshdvw0d84zp2zpi0ms2405z88sbd9vcv13x8cjh7nn2cmvj1j")))

(define nvidia-source-580-aarch64-linux
  (make-nvidia-source
   "580.159.03"
   "aarch64"
   (base32 "1n07m597n6q3ybgxc8vrgzcnkqnx0363bgb98x6ky6447y34am2l")))
...
(define nvidia-source-595-x86_64-linux
  (make-nvidia-source
   "595.71.05"
   "x86_64"
   (base32 "10kbdy2ds1mgk2vj8arxx42lmqydcdc1zfpn8a59rr5pc24kn81n")))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32
         "0cz31348jvrjqs08a21dqjwlpjg5fwx4ck8d4y56lp96yz4qjl8y"))
       (patches
...
(define-public nvidia-modprobe-580
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1g4pc51xq5pzifvzdf9gzd0dndyjbdxdblh0rjrgg8w3c16n7p4y"))))
