...
| Code name    | Series                             | nvda-beta | nvda-new-feature | nvda-595 | nvda-580 | ⚠️ nvda-470 | ⚠️ nvda-390 | Nouveau |
|--------------+------------------------------------+-----------+------------------+----------+----------+--------------+--------------+---------|
...
*NOTE*:
- Open source kernel modules are supported since Turing and required since
  Blackwell.  Additionally, these modules may be unusable unless [[https://codeberg.org/guix/guix/issues/10409][guix/guix#10409]]
  is resolved.
- Drivers marked as ⚠️ are no longer supported by upstream and won't receive
  functionality or security updates.
- =nvda-beta= and =nvda-new-feature= are not production-ready.
...
|------------------+------------------|
| nvda-beta        | nvda-beta        |
| nvda-new-feature | nvda-new-feature |
| nvda-595         | nvda@595         |
| nvda-580         | nvda@580         |
| nvda-470         | nvda@470         |
| nvda-390         | nvda@390         |
...
|-----------------------------+-----------------------------|
| ffmpeg/nvidia-beta          | ffmpeg-nvidia-beta          |
| ffmpeg/nvidia-new-feature   | ffmpeg-nvidia-new-feature   |
| ffmpeg/nvidia-595           | ffmpeg-nvidia@595           |
| ffmpeg/nvidia-580           | ffmpeg-nvidia@580           |
| ffmpeg/nvidia-470           | ffmpeg-nvidia@470           |
| ffmpeg/nvidia-390           | ffmpeg-nvidia@390           |
| ffmpeg-6/nvidia-beta        | ffmpeg-6-nvidia-beta        |
| ffmpeg-6/nvidia-new-feature | ffmpeg-6-nvidia-new-feature |
| ffmpeg-6/nvidia-595         | ffmpeg-6-nvidia@595         |
| ffmpeg-6/nvidia-580         | ffmpeg-6-nvidia@580         |
| ffmpeg-6/nvidia-470         | ffmpeg-6-nvidia@470         |
| ffmpeg-6/nvidia-390         | ffmpeg-6-nvidia@390         |

| Variable                  | Specification             |
|---------------------------+---------------------------|
| heroic-nvidia-beta        | heroic-nvidia-beta        |
| heroic-nvidia-new-feature | heroic-nvidia-new-feature |
...
| steam-nvidia-new-feature | steam-nvidia-new-feature |
    ...
    (services (list
               (simple-service 'nonguix-substitutes guix-service-type
                               (guix-extension
                                 ...
                                 (authorized-keys (list (local-file "./signing-key.pub")))))
               ...))
    ...)
#+END_SRC
